<section class="flex flex-col shadow-2xl md:flex-row overflow-clip">
  ...
  <div
    class="flex flex-col px-2 py-4 font-semibold transition-all duration-300 md:text-left bg-gunmetal hover:bg-slate-700 text-lightCyan md:p-12 md:w-1/2"
  >
    ...
    <p class="text-xl text-justify">
      ...
      intention to form a winning team with them.
    </p>
    <br />
  </div>
  ...
  <!--vv Right/Bottom Side vv-->

  <div
    class="flex flex-col px-2 py-4 font-semibold transition-all duration-300 md:text-right bg-celestialBlue hover:bg-cyan-700 md:p-12 text-slate-100 md:w-1/2"
  >
    ...
    <p class="text-xl text-justify">
      ...
      employees, who will organically transmit the same culture to our clients.
    </p>
    <br />
  </div>
