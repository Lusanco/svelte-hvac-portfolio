  ...
  <div class="container p-4 mx-auto space-y-16 sm:p-10">
    <div class="space-y-4">
      ...
      <p class="max-w-2xl text-gray-400">
        Our dedicated team of experts brings years of experience and passion to
        every project. Meet the individuals who are committed to providing
        exceptional HVAC and mechanical solutions.
      </p>
    </div>
    <div class="grid w-full grid-cols-1 gap-6 md:grid-cols-2">
      <div class="flex space-x-6">
        <img
          alt=""
          class="flex-1 flex-shrink-0 object-cover h-56 mb-4 bg-gray-500 bg-center rounded-sm"
          src="https://source.unsplash.com/240x320/?portrait?2"
        />
        <div class="flex flex-col">
          <h4 class="text-xl font-semibold">Geraldo Peña</h4>
          <p class="text-sm text-gray-400">Mechanical Engineer</p>
